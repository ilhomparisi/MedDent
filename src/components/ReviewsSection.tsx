...
export default function ReviewsSection() {
  ...
  const uiTexts = {
    title_align: getConfig('reviews_title_align', 'center'),
    subtitle_align: getConfig('reviews_subtitle_align', 'center'),
    title_size: getConfig('reviews_title_size', '36'),
    subtitle_size: getConfig('reviews_subtitle_size', '18'),
  };
  
  const gradientSettings = {
    opacity: getConfig('reviews_gradient_opacity', '0.25'),
    width: getConfig('reviews_gradient_width', '90'),
    height: getConfig('reviews_gradient_height', '85'),
    blur: getConfig('reviews_gradient_blur', '60'),
  };
  ...
  const fetchReviews = async () => {
    try {
      ...
      const reviewsWithLang = data.map((review: any) => ({
        ...review,
